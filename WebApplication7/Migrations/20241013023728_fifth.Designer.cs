...
namespace WebApplication7.Migrations
{
    ...
    [Migration("20241013023728_fifth")]
    partial class fifth
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DEPI.Models.Booking", b =>
                {
            ...
            modelBuilder.Entity("DEPI.Models.Membership", b =>
                {
            ...
            modelBuilder.Entity("DEPI.Models.Payment", b =>
                {
            ...
            modelBuilder.Entity("DEPI.Models.Place", b =>
                {
                    b.Property<int>("Place_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DEPI.Models.Promotion", b =>
                {
                    b.Property<int>("promotion_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DEPI.Models.Review", b =>
                {
            ...
            modelBuilder.Entity("DEPI.Models.Booking", b =>
                {
                    b.HasOne("DEPI.Models.Place", "place")
                        .WithMany()
            ...
            modelBuilder.Entity("DEPI.Models.Membership", b =>
                {
                    ...
                    b.HasOne("DEPI.Models.Promotion", "promotion")
                        .WithMany()
            ...
            modelBuilder.Entity("DEPI.Models.Payment", b =>
                {
                    b.HasOne("DEPI.Models.Booking", "booking")
                        .WithMany()
